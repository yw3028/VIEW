module.exports = {
  dbMovies: [
    {
      poster: '/elZ6JCzSEvFOq4gNjNeZsnRFsvj.jpg',
      apiId: 741067,
      backdrop: '/aO5ILS7qnqtFIprbJ40zla0jhpu.jpg',
    ...
    {
      poster: '/ov1sd4gvHpoVheHuJHCXJjadeIT.jpg',
      apiId: 660982,
      backdrop: '/75ooojtgiKYm5LcCczbCexioZze.jpg',
      title: 'American Pie Presents: Girls Rules',
      avgRating: 6.4,
      plot:
        'Its Senior year at East Great Falls. Annie, Kayla, Michelle, and Stephanie decide to harness their girl power and band together to get what they want their last year of high school.',
      releaseDate: '2020-10-06',
    },
    {
      poster: '/6CoRTJTmijhBLJTUNoVSUNxZMEI.jpg',
      apiId: 694919,
      backdrop: '/pq0JSpwyT2URytdFG0euztQPAyR.jpg',
      title: 'Money Plane',
      avgRating: 6.1,
      plot:
        'A professional thief with $40 million in debt and his familys life on the line must commit one final heist - rob a futuristic airborne casino filled with the worlds most dangerous criminals.',
      releaseDate: '2020-09-29',
    },
    {
    ...
    {
      poster: '/z0r3YjyJSLqf6Hz0rbBAnEhNXQ7.jpg',
      apiId: 697064,
      backdrop: '/7WKIOXJa2JjHygE8Yta3uaCv6GC.jpg',
      title: 'Beckman',
      avgRating: 6.3,
      plot:
    ...
    {
      poster: '/9Rj8l6gElLpRL7Kj17iZhrT5Zuw.jpg',
      apiId: 734309,
      backdrop: '/7fvdg211A2L0mHddvzyArRuRalp.jpg',
      title: 'Santana',
      avgRating: 5.6,
      plot:
    ...
    {
      poster: '/uQnqhfxWaw2fN3bgpDbO0RVFHLF.jpg',
      apiId: 617505,
      backdrop: '/aOeshAxAhiDVIiHsXVFmF6bgclh.jpg',
    ...
    },
    {
      ...
      avgRating: 5.8,
      plot:
        'Artemis Fowl is a 12-year-old genius and descendant of a long line of criminal masterminds. He soon finds himself in an epic battle against a race of powerful underground fairies who may be behind his fathers disappearance.',
      releaseDate: '2020-06-12',
    },
    {
      poster: '/xOmGTJtBgRVSAF4S5dZEUqHqyy5.jpg',
      apiId: 621870,
      backdrop: '/oSSEcPDfwgZSv2i01Oqxdb9t8fI.jpg',
    ...
    {
      poster: '/vJHSParlylICnI7DuuI54nfTPRR.jpg',
      apiId: 438396,
      backdrop: '/qGZe9qTuydxyJYQ60XDtEckzLR8.jpg',
    ...
    },
    {
      ...
      avgRating: 7.2,
      plot:
        'A hit man named Kai flies into Bangkok, gets a gun, and orders a cab. He offers a professional female driver big money to be his all-night driver. But when she realizes Kai is committing brutal murders at each stop, its too late to walk away. Meanwhile, an offbeat police detective races to decode the string of slayings before more blood is spilled.',
      releaseDate: '2020-08-25',
    },
    {
      poster: '/qOYf3L6eyCO027JoeM33pTJcNSR.jpg',
      apiId: 623634,
      backdrop: '/fbjzxbWAUijs0fsQ6Hlbls0NtAj.jpg',
      title: 'The Innocence',
      avgRating: 6.4,
      plot:
    ...
    {
      poster: '/4BgSWFMW2MJ0dT5metLzsRWO7IJ.jpg',
      apiId: 726739,
      backdrop: '/t22fWbzdnThPseipsdpwgdPOPCR.jpg',
      title: 'Cats & Dogs 3: Paws Unite',
      avgRating: 6.5,
      plot:
        'Its been ten years since the creation of the Great Truce, an elaborate joint-species surveillance system designed and monitored by cats and dogs to keep the peace when conflicts arise. But when a tech-savvy villain hacks into wireless networks to use frequencies only heard by cats and dogs, he manipulates them into conflict and the worldwide battle between cats and dogs is BACK ON. Now, a team of inexperienced and untested agents will have to use their old-school animal instincts to restore order and peace between cats and dogs everywhere.',
  ...
  dbJournals: [
    ...
    {
      title: 'Mistical Night',
      entry:
        'Arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc',
      location: 'Antananaribo',
      weather: 'Sunny',
